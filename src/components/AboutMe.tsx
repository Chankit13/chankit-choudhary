          ...
          <div className="flex-1 min-w-0">
            <div className="flex flex-col h-full">
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">@Chankit13</p>
              </div>
              ...
              <div className="flex-1 bg-gray-50 dark:bg-[#1E2330] rounded-lg p-4 mb-8 mt-4">
                <div className="space-y-3">
                  ...
                  <p className="text-md text-gray-600 dark:text-gray-300 leading-relaxed">
                    AI? Oh, that&apos;s my jam. I geek out on building models that tap into the magic of AI.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-auto">
                <div className="flex items-center space-x-4">
                  <a 
                    href="https://twitter.com/ChankitC13" 
                    target="_blank"
                  ...
                  <a 
                    href="https://github.com/Chankit13" 
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a 
                    href="https://linkedin.com/in/chankit-choudhary" 
                    target="_blank"
                    rel="noopener noreferrer"
